...
import type {ConversationInput, FieldSuggestion, SuggestedUpdates, TagSuggestion} from "./types"
...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.SuggestedUpdates> {
          try {
          ...
          const __stream__ = this.stream.ExtractContactInfo(
          input,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.SuggestedUpdates
            } catch (error) {
            ...
            input: types.ConversationInput,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.SuggestedUpdates, types.SuggestedUpdates>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for ExtractContactInfo", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.SuggestedUpdates, types.SuggestedUpdates>(
                  __raw__,
                  (a): partial_types.SuggestedUpdates => a,
                  (a): types.SuggestedUpdates => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
